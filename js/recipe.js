...
const addRecipeIngredients = ingredients => {
  ...
  getIngredientSpecialsObj().then((specials) => {
    ingredients.forEach((ingredient, index) => {
      ...
      // add specials notes
      if (specials.hasOwnProperty(ingredient.uuid)) {
        const specialContent = specials[ingredient.uuid];
        newIngredientItem
          .append('<br>' + specialContent.title + ' (' + specialContent.type + ')')
          .append(specialContent.text);
      }
    });
